...
const Blog = () => {
  return (
    <section className="relative mx-auto p-5">
      ...
      <div className="relative max-w-150 ml-auto mr-0">
        <h2 className="text-[clamp(2.75rem,8vw,5rem)] font-bold text-right">&lt;Blog /&gt;</h2>
        <div className="bg-black h-2 absolute w-full"></div>
      </div>

      <div className="mt-15 space-y-5 max-w-120 text-lg font-medium text-gray-600">       
        <p>
        ...
        <Link
          className="block bg-black text-white px-5 py-3 w-full cursor-pointer font-bold rounded-md hover:bg-gray-700 transition-colors duration-300 text-center"
          href="/posts"
        >
          Go to Blog -&gt;
        </Link> 
